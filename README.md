...
[![Watering System Using H4Plugins](https://img.youtube.com/vi/ENXZjkuhxrc/0.jpg)](https://www.youtube.com/watch?v=ENXZjkuhxrc)
...
[H4](https://github.com/HamzaHajeir/H4) and its plugin system represent a *very* different way of getting started on ESPs and RPI Picos from the "standard" examples found all over the web.
...
|| Name | Provides | Notes |
| :---: | :----------  | :--- | :--- |
||[H4AsyncTCP](https://github.com/HamzaHajeir/H4AsyncTCP)|"Glue" to LwIP| Reliable Async TCP Library |
||[H4AsyncWebServer](https://github.com/HamzaHajeir/H4AsyncWebServer)| Basis of webUI in H4Plugins| Reliable Webserver with Websockets support |
|![roadmap](assets/common/tools_icon.jpg)|[H4Tools](https://github.com/HamzaHajeir/h4tools)|'32/'8266/RP2040 HAL and utility functions | |
|![roadmap](assets/common/pangolin_icon.jpg)|[H4AsyncMQTT](https://github.com/HamzaHajeir/H4AsyncMQTT)|Async MQTT Client|QoS 0/1/2 Fully 3.1.1/5.0 compliant. Large payloads |
...
* [ESP32 core 3.3.6](https://github.com/espressif/arduino-esp32)
...
1. Download, install and play with [H4](https://github.com/HamzaHajeir/H4). Pick one or two of the examples and run it.

2. Read the [H4](https://github.com/HamzaHajeir/H4) documentation carefully. Everything H4P does is based on using the features of the scheduing library. As the examples here use the library's API extensively.
...
9. Now work your way through several of the [GPIO examples](examples/GPIO). Start with ["raw"](examples\01_GPIO_PIN_MACHINE\PM_01_Raw\PM_01_Raw.ino) and then ["debounced"](examples\01_GPIO_PIN_MACHINE\PM_03_Debounced\PM_03_Debounced.ino) - once you understand those two all the rest will start to make a lot more sense. If you DO have a [rotary encoder](examples\01_GPIO_PIN_MACHINE\PM_13_Encoder\PM_13_Encoder.ino), hook it up and delight in the ease with which you will be able to use it!
...
11.  At each stage above, check out the dedicated [H4Plugins Youtube channel](https://www.youtube.com/channel/UCYi-Ko76_3p9hBUtleZRY6g) to see if the relevant video has been produced yet - working as fast as possible to get a whole video library out there for you.
...
1. As with all H4 and H4Plugins libraries, please make sure you have read the relevant documentation relating to the issue and watched any videos on the [Youtube channel (instructional videos)](https://www.youtube.com/channel/UCYi-Ko76_3p9hBUtleZRY6g).

2. If there is a genuine issue then you will be referred to [Raising issues](docs/issues.md) after which you are advised to create a full github issue report.
